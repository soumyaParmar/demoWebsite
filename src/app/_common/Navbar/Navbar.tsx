...
const Navbar:React.FC = () => {
  ...
  const [open,setOpen] = useState<boolean>(false)
    const items: MenuProps['items'] = [
        {
            ...
            <div className={styles.what}>
              ...
              <div>
                ...
                <p>Powerful options to security authenticate and manage your users</p>
              </div>
            </div>
            </Link>
            )
    ...
    const handleMenu = () =>{
      if(!open && devref.current && devref1.current && devref2.current){
        ...
        setOpen(false); 
        devref.current.style.height = "60px"
  ...
  return (
    ...
    <div className={styles.nav_outer} ref={devref}>
      <div className={styles.menu} onClick={handleMenu}><MenuIcon fontSize='large'/></div>
      <div className={styles.nav_innerOne} ref={devref1}>
        <Dropdown menu={{items}} className={styles.drop} overlayClassName={styles.customDropdown}>
            <Space>
                What we do
                <CaretDownOutlined />
            </Space>           
