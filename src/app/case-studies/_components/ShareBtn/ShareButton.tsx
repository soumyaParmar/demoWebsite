...
const ShareButton: React.FC<ShareButtonProps> = ({ url, title }) => {
  ...
  return (
    <>
      <div className={`${styles.container} ${inter500.className}`}>
        {/* <div className={styles.heading}>Share:</div> */}
        <span className={styles.heading}>Share it on:</span>
        ...
        <div className={styles.shareBtnContainer}>
          ...
          <TwitterShareButton url={url} title={title}>
            <div className={styles.shareBtn}>
              <svg viewBox="0 0 64 64" width="50" height="50">
                <circle cx="32" cy="32" r="32" fill="#222222"></circle>
                <path
          ...
          <CopyToClipboard text={url} onCopy={handleCopy}>
            <div className={styles.shareBtn}>
              <button>{copied ? <DoneIcon /> : <ContentCopyIcon />}</button>
