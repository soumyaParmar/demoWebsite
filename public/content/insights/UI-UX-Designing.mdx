---
title: 'UI/UX - Design Thinking UI/UX - Design Thinking UI/UX - Design Thinking UI/UX - Design Thinking'
publishedAt: '30-06-2024'
summary: 'An overview of databases that pair well with modern application and compute providers. An overview of databases that pair well with modern application and compute providers.'
image: "https://media.dev.to/cdn-cgi/image/width=500,height=500,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fq1b7jvocwhh9r6dsn3wu.jpg"
category: 'Design'
author: "Nikhil"
---

![Cover image](https://media.dev.to/cdn-cgi/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fq1b7jvocwhh9r6dsn3wu.jpg)

Written By: Nikhil <br /> Date: 30-06-2024
<br />
